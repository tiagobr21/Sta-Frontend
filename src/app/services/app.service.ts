...
export class AppService{
  ...
  urlGerarPdfGeral = 'http://localhost:3000/escala_geral/gerarpdf';
  urlGetPdfGeral = 'http://localhost:3000/escala_geral/getpdf';
  urlDeletePdfGeral = 'http://localhost:3000/escala_geral/deletepdf';
