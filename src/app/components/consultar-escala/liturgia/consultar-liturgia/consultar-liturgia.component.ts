...
@Component({
  selector: 'app-consultar-liturgia',
  templateUrl: './consultar-liturgia.component.html',
  styleUrls: ['./consultar-liturgia.component.css']
})
export class ConsultarLiturgiaComponent implements OnInit {
...
>>>>>>> 9837d96b3a8dbc641958f83d0522e1144d2ac666
   ...
   printSimplePDF():any{
     ...
     if(this.pagina2[0] == null){
        ...
        this.service.gerarPdfLiturgia(formData).subscribe((res)=>{
         this.response = res
         this.loading = false
 ...
 if(error.error?.message){
  ...
  this.snackbar.openSnackBar(this.response,GlobalConstants.error);
   ...
   deleteID(id:any){
     this.loading = true
     this.service.deleteDataLiturgia(id).subscribe((res)=>{
